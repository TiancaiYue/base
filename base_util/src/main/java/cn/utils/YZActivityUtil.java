...
/**
 * Created by base on 2018/09/26.
 */
public class YZActivityUtil {
    ...
    public static void launchActivity(Context context, String packageName, String className, Bundle bundle) {
        context.startActivity(YZIntentUtil.getComponentNameIntent(packageName, className, bundle));
    }
     ...
     * @param goal
     */
    public static void skipActivityNewTask(Context context, Class<?> goal, Bundle bundle) {
        Intent intent = new Intent(context, goal);
        intent.putExtras(bundle);
     ...
     * @param goal
     */
    public static void skipActivityNewTask(Context context, Class<?> goal) {
        Intent intent = new Intent(context, goal);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        context.startActivity(intent);
    }
    ...
    public static void skipActivityForResult(Activity context, Class<?> goal, int requestCode) {
        ...
        (context).overridePendingTransition(R.anim.zoom_center_in, 0);
    }
